      ...
      <div class="row">
        <div class="col-4">
          ...
          >
            ...
            <option value="mask">Summer Males Perfumes</option>
            <option value="wetsuits">Summer Females Perfumes</option>
            <option value="camera">Winter Males Perfumes</option>
            <option value="camera">Winter Females Perfumes</option>
          </select>
        </div>
        <div class="col-4">
          <form class="d-flex">
